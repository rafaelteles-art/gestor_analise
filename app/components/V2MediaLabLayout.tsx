    ...
    <div className="flex min-h-screen bg-[#f4f7fb] text-gray-800 font-sans">
      ...
      <aside className="w-64 bg-white border-r border-gray-200 flex flex-col hidden md:flex min-h-screen">
        ...
        <nav className="flex-1 px-4 space-y-1">
          ...
          <Link href="/analise" className={`flex items-center gap-3 px-3 py-2.5 rounded-lg font-medium text-sm transition-colors ${pathname === '/analise' ? 'bg-indigo-50 text-indigo-600' : 'text-gray-600 hover:bg-gray-50'}`}>
            <svg className={`w-5 h-5 ${pathname === '/analise' ? '' : 'opacity-70'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" /></svg>
            Análise
          </Link>
